import { MediaCompositionProps } from "../compositions/media-composition";
import { GraphicsLayer, MainComposition, MediaLayer } from "./types";
...
const USER_PHOTO_URLS: MediaLayer[] = [
  {
    start_time: 0,
    end_time: 8,
    src: "https://images.pexels.com/photos/5480696/pexels-photo-5480696.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
  },
  {
    start_time: 8,
    end_time: 11,
    src: "https://images.pexels.com/photos/5480687/pexels-photo-5480687.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
  },
  {
    start_time: 11,
    end_time: 13,
    src: "https://images.pexels.com/photos/5480688/pexels-photo-5480688.jpeg",
  },
  {
    start_time: 13,
    src: "https://images.pexels.com/photos/5480698/pexels-photo-5480698.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
  },
];
...
const MEDIA_COMPOSITION_DATA: MediaCompositionProps = {
  user_photos: USER_PHOTO_URLS,
  stock_video: {
    start_time: 0,
    src: STOCK_PHOTO_URL,
  },
...
const GRAPHIC_COMPOSITION_DATA = [
  LOCATION_TEXT,
  HIGHLIGHT_TEXT,
  SUBHIGHLIGHT_TEXT,
  ...CAPTIONS,
